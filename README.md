...
1. Unity의 **Asset > Import package** 메뉴를 클릭해 적용하려는 Unity 게임 프로젝트에 PLUG SDK 패키지를 불러옵니다. Unity Package 2.5.4 에는 다음과 같은 PLUG SDK를 포함하고 있습니다.
    - NaverCafeSDK For Android 2.5.2
    - NaverCafeSDK For iOS 2.5.5
...
## v.2.5.4
Unity Package 2.5.4 에는 다음과 같은 NaverCafeSDK 를 포함하고 있습니다.
