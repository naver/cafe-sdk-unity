...
1. Go to **Asset** and click **Import package** to import the PLUG SDK package to your Unity game project. The following SDKs are included in the Unity Package 2.5.2.  
